//// мб проблема в этом: t3 = t3 + PI / 2;
////надо понять откуда оно взялось и почему так работает 

//final float[] l={0, 100, 100, 100, 100};

//private float x=l[3]+l[4];
//private float y=0;
//private float z=l[1]+l[2];
//private float x1;
//private float y1;
//private float z1;
//private float x2;
...
////вероянто это не работает, тк нет угла 4 
...
//  float[] angles={PI/4, PI/3, -PI/3, PI/4, PI/5, PI};
//  R=getR(angles[0], angles[1], angles[2], angles[3], angles[4], angles[5]);
